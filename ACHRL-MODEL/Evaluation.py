...
import math
# evaluation:评价指标，最常用的是准确率。。。，在这里 NDCG，HR10等等
# 这里应该是拎出来的处理业务的函数，为Train 和 Test服务的
# predict_with_atteionts 和 eval_rating 这俩重量级函数，被 rain 和 Test 调用
# 下面的一些小函数/方法 两个重量级函数调用的，也即是在本文件内被调使用
